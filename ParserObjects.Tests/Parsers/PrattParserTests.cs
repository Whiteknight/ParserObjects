...
namespace ParserObjects.Tests.Parsers
{
    public class PrattParserTests
    {
        ...
        [Test]
        public void ReplaceChild_Value()
        {
            var number = Digit().Transform(c => c.ToString());
            var plus = Match('+');
            var neg = Match('-');
            ...
            var newNumber = DigitString();

            var newTarget = target.ReplaceChild(number, newNumber);
            newTarget.Should().NotBeSameAs(target);
            var children = newTarget.GetChildren().ToList();
            children.Count.Should().Be(8);
            children.Should().Contain(newNumber);
            children.Should().Contain(plus);
            children.Should().Contain(neg);
            children.Should().Contain(bang);
            children.Should().Contain(oParen);
        ...
        [Test]
        public void ReplaceChild_Infix()
        {
            var number = Digit().Transform(c => c.ToString());
            var plus = Match('+');
            var neg = Match('-');
            ...
            var newTarget = target.ReplaceChild(plus, newParser);
            newTarget.Should().NotBeSameAs(target);
            var children = newTarget.GetChildren().ToList();
            children.Count.Should().Be(8);
            children.Should().Contain(number);
            children.Should().Contain(newParser);
            children.Should().Contain(neg);
            children.Should().Contain(bang);
            children.Should().Contain(oParen);
            children.Should().Contain(cParen);
        ...
        [Test]
        public void ReplaceChild_Prefix()
        {
            var number = Digit().Transform(c => c.ToString());
            var plus = Match('+');
            var neg = Match('-');
            ...
            var newTarget = target.ReplaceChild(neg, newParser);
            newTarget.Should().NotBeSameAs(target);
            var children = newTarget.GetChildren().ToList();
            children.Count.Should().Be(8);
            children.Should().Contain(number);
        ...
        [Test]
        public void ReplaceChild_Postfix()
        {
            var number = Digit().Transform(c => c.ToString());
            var plus = Match('+');
            var neg = Match('-');
            ...
            var newTarget = target.ReplaceChild(bang, newParser);
            newTarget.Should().NotBeSameAs(target);
            var children = newTarget.GetChildren().ToList();
            children.Count.Should().Be(8);
            children.Should().Contain(number);
        ...
        [Test]
        public void ReplaceChild_CircumfixOpen()
        {
            var number = Digit().Transform(c => c.ToString());
            var plus = Match('+');
            var neg = Match('-');
            ...
            var newTarget = target.ReplaceChild(oParen, newParser);
            newTarget.Should().NotBeSameAs(target);
            var children = newTarget.GetChildren().ToList();
            children.Count.Should().Be(8);
            children.Should().Contain(number);
        ...
        [Test]
        public void ReplaceChild_CircumfixClose()
        {
            var number = Digit().Transform(c => c.ToString());
            var plus = Match('+');
            var neg = Match('-');
            ...
            var newTarget = target.ReplaceChild(cParen, newParser);
            newTarget.Should().NotBeSameAs(target);
            var children = newTarget.GetChildren().ToList();
            children.Count.Should().Be(8);
            children.Should().Contain(number);
        ...
        [Test]
        public void ReplaceChild_PostcircumfixOpen()
        {
            var number = Digit().Transform(c => c.ToString());
            var plus = Match('+');
            var neg = Match('-');
            ...
            var newTarget = target.ReplaceChild(oBracket, newParser);
            newTarget.Should().NotBeSameAs(target);
            var children = newTarget.GetChildren().ToList();
            children.Count.Should().Be(8);
            children.Should().Contain(number);
        ...
        [Test]
        public void ReplaceChild_PostcircumfixClose()
        {
            var number = Digit().Transform(c => c.ToString());
            var plus = Match('+');
            var neg = Match('-');
            ...
            var newTarget = target.ReplaceChild(cBracket, newParser);
            newTarget.Should().NotBeSameAs(target);
            var children = newTarget.GetChildren().ToList();
            children.Count.Should().Be(8);
            children.Should().Contain(number);
