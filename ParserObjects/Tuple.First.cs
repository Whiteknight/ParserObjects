...
public static partial class TupleExtensions
{
    ...
    {
        return new FirstParser<TInput>.WithOutput<TOutput>(new[] { parsers.Item1, parsers.Item2 });
    }
    ...
    {
        return new FirstParser<TInput>.WithOutput<TOutput>(new[] { parsers.Item1, parsers.Item2, parsers.Item3 });
    }
    ...
    {
        return new FirstParser<TInput>.WithOutput<TOutput>(new[] { parsers.Item1, parsers.Item2, parsers.Item3, parsers.Item4 });
    }
    ...
    {
        return new FirstParser<TInput>.WithOutput<TOutput>(new[] { parsers.Item1, parsers.Item2, parsers.Item3, parsers.Item4, parsers.Item5 });
    }
    ...
    {
        return new FirstParser<TInput>.WithOutput<TOutput>(new[] { parsers.Item1, parsers.Item2, parsers.Item3, parsers.Item4, parsers.Item5, parsers.Item6 });
    }
    ...
    {
        return new FirstParser<TInput>.WithOutput<TOutput>(new[] { parsers.Item1, parsers.Item2, parsers.Item3, parsers.Item4, parsers.Item5, parsers.Item6, parsers.Item7 });
    }
    ...
    {
        return new FirstParser<TInput>.WithOutput<TOutput>(new[] { parsers.Item1, parsers.Item2, parsers.Item3, parsers.Item4, parsers.Item5, parsers.Item6, parsers.Item7, parsers.Item8 });
    }
    ...
    {
        return new FirstParser<TInput>.WithOutput<TOutput>(new[] { parsers.Item1, parsers.Item2, parsers.Item3, parsers.Item4, parsers.Item5, parsers.Item6, parsers.Item7, parsers.Item8, parsers.Item9 });
    }
}
