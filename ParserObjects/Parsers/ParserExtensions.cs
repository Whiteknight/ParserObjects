...
namespace ParserObjects.Parsers
{
    ...
    public static class ParserExtensions
    {
        ...
        /// <returns></returns>
        public static IParser<TInput, TOutput> Examine<TInput, TOutput>(this IParser<TInput, TOutput> parser, Action<IParser<TInput, TOutput>, ISequence<TInput>> before = null, Action<IParser<TInput, TOutput>, ISequence<TInput>, IParseResult<TOutput>> after = null)
