...
public delegate (bool maches, int length) TestFunc(CaptureCollection captures, List<IState> states, SequenceBuffer<char> buffer);
...
public sealed class RegexContext
{
    ...
    public RegexContext(IReadOnlyList<IState> states, CaptureCollection captures)
    {
...
public static class Engine
{
    ...
    private static (bool matches, int length) Test(CaptureCollection captures, IReadOnlyList<IState> states, SequenceBuffer<char> buffer)
    {
    ...
    private static bool TestExactlyOne(RegexContext context, SequenceBuffer<char> buffer)
    {
        ...
        var (matches, consumed) = context.CurrentState.Match(context, buffer, context.Index, Test);
        if (matches)
        {
