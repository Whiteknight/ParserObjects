...
public sealed class BuiltInTypesBnfStringifyVisitor : IBuiltInPartialVisitor<BnfStringifyState>
{
    ...
    public void Accept<TInput, TMiddle, TOutput>(ComposeParser<TInput, TMiddle, TOutput> p, BnfStringifyState state)
    {
    ...
    public void Accept<TInput, TOutput, TParser>(DeferredParser<TInput, TOutput, TParser> p, BnfStringifyState state)
    ...
    public void Accept<TInput, TOutput, TData>(Sequential.Parser<TInput, TOutput, TData> p, BnfStringifyState state)
    {
        ...
        BnfDescription.Append(state, description, p.GetChildren().ToList());
    }
    ...
    public void Accept<TInput, TMiddle, TOutput, TData>(Transform<TInput>.Parser<TMiddle, TOutput, TData> p, BnfStringifyState state)
    {
        state.Append(p.GetChildren().First());
    }

    public void Accept<TInput, TMiddle, TOutput, TData>(Transform<TInput>.MultiParser<TMiddle, TOutput, TData> p, BnfStringifyState state)
    {
        state.Append(p.GetChildren().First());
    }
