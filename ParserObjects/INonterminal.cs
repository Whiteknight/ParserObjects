...
public static class NonterminalExtensions
{
    ...
    /// <param name="s1"></param>
    /// <returns></returns>
    public static INonterminal<TInput, TOutput> Rule<TInput, TOutput>(
        this INonterminal<TInput, TOutput> lhs,
        ISymbol<TOutput> s1
    ) => lhs.Rule(s1, v => v);
    ...
    /// <returns></returns>
    public static INonterminal<TInput, TOutput> Rule<TInput, TOutput, T1>(
        this INonterminal<TInput, TOutput> lhs,
        ISymbol<T1> s1,
    ...
    /// <param name="func"></param>
    /// <returns></returns>
    public static INonterminal<TInput, TOutput> Rule<TInput, TOutput, T1, T2>(
        this INonterminal<TInput, TOutput> lhs,
        ISymbol<T1> s1,
        ISymbol<T2> s2,
    ...
    /// <param name="func"></param>
    /// <returns></returns>
    public static INonterminal<TInput, TOutput> Rule<TInput, TOutput, T1, T2, T3>(
        this INonterminal<TInput, TOutput> lhs,
        ISymbol<T1> s1,
        ISymbol<T2> s2,
        ISymbol<T3> s3,
    ...
    /// <param name="func"></param>
    /// <returns></returns>
    public static INonterminal<TInput, TOutput> Rule<TInput, TOutput, T1, T2, T3, T4>(
        this INonterminal<TInput, TOutput> lhs,
        ISymbol<T1> s1,
        ISymbol<T2> s2,
        ISymbol<T3> s3,
    ...
    /// <param name="func"></param>
    /// <returns></returns>
    public static INonterminal<TInput, TOutput> Rule<TInput, TOutput, T1, T2, T3, T4, T5>(
        this INonterminal<TInput, TOutput> lhs,
        ISymbol<T1> s1,
        ISymbol<T2> s2,
        ISymbol<T3> s3,
    ...
    /// <param name="func"></param>
    /// <returns></returns>
    public static INonterminal<TInput, TOutput> Rule<TInput, TOutput, T1, T2, T3, T4, T5, T6>(
        this INonterminal<TInput, TOutput> lhs,
        ISymbol<T1> s1,
        ISymbol<T2> s2,
        ISymbol<T3> s3,
    ...
    /// <param name="func"></param>
    /// <returns></returns>
    public static INonterminal<TInput, TOutput> Rule<TInput, TOutput, T1, T2, T3, T4, T5, T6, T7>(
        this INonterminal<TInput, TOutput> lhs,
        ISymbol<T1> s1,
        ISymbol<T2> s2,
        ISymbol<T3> s3,
    ...
    /// <param name="func"></param>
    /// <returns></returns>
    public static INonterminal<TInput, TOutput> Rule<TInput, TOutput, T1, T2, T3, T4, T5, T6, T7, T8>(
        this INonterminal<TInput, TOutput> lhs,
        ISymbol<T1> s1,
        ISymbol<T2> s2,
        ISymbol<T3> s3,
    ...
    /// <param name="func"></param>
    /// <returns></returns>
    public static INonterminal<TInput, TOutput> Rule<TInput, TOutput, T1, T2, T3, T4, T5, T6, T7, T8, T9>(
        this INonterminal<TInput, TOutput> lhs,
        ISymbol<T1> s1,
        ISymbol<T2> s2,
        ISymbol<T3> s3,
