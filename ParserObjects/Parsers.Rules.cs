...
public static partial class Parsers<TInput>
{
    ...
    /// <returns></returns>
    public static IParser<TInput, TOutput> Rule<T1, T2, TOutput>(
    ...
    /// <param name="produce"></param>
    /// <returns></returns>
    public static IParser<TInput, TOutput> Rule<T1, T2, T3, TOutput>(
        IParser<TInput, T1> p1,
        IParser<TInput, T2> p2,
    ...
    /// <param name="produce"></param>
    /// <returns></returns>
    public static IParser<TInput, TOutput> Rule<T1, T2, T3, T4, TOutput>(
        IParser<TInput, T1> p1,
        IParser<TInput, T2> p2,
        IParser<TInput, T3> p3,
    ...
    /// <param name="produce"></param>
    /// <returns></returns>
    public static IParser<TInput, TOutput> Rule<T1, T2, T3, T4, T5, TOutput>(
        IParser<TInput, T1> p1,
        IParser<TInput, T2> p2,
        IParser<TInput, T3> p3,
        IParser<TInput, T4> p4,
